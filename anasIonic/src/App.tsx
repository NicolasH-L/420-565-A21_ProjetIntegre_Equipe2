...
import StudentCV from './components/Student/StudentCV';
import OfferView from './components/Admin/OfferView';
  ...
  <IonApp>
    <IonReactRouter>
      ...
      <IonRouterOutlet id="main">
        ...
        <Route path="/studentDash" component={Student} exact={true} />
        <Route path="/studentCV" component={StudentCV} exact={true} />
        ...
        <Route path="/adminOfferView" component={OfferView} exact={true} />
      </IonRouterOutlet>
    </IonReactRouter>
  </IonApp>
);
