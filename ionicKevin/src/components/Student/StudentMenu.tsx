...
import { attach, exitOutline } from 'ionicons/icons';
import '../Menu.css'
      ...
      <IonContent>
        <IonList id="inbox-list">
          ...
          {/*<IonMenuToggle autoHide={false}>
            <IonItem className="ion-margin-vertical" routerLink="/authentificationPage/studentAuth" routerDirection="none" lines="none" detail={false}>
              <IonIcon color="danger" slot="start" ios={exitOutline} md={exitOutline} />
