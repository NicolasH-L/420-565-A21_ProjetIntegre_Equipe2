...
const AdminAssignSupervisorToStudent = () => {
    ...
    const addSupervisorToIntership = async (internship) => {
        const result = await fetch('http://10.10.68.10:8888/internship/save-internship',
            {
                method: 'POST',
                headers: {
    ...
    const fetchInternships = async () => {
        const res = await fetch('http://10.10.68.10:8888/internship/get-all-internships')
        return await res.json()
    }

    const fetchSupervisors = async () => {
        const res = await fetch('http://10.10.68.10:8888/supervisors/get-all-supervisors')
        return await res.json()
    }
