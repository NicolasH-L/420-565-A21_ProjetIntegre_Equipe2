...
const AdminStudentAcceptedOffers = () => {
    ...
    const studentTerms = "Accomplir ou réaliser les taches demandées par le moniteur. Ameliorer ou continuer à developper auprès de l'équipe et s'assurer que tout est conforme."
