...
const AdminStudentAcceptedOffers = () => {
    ...
    const fetchOffers = async () => {
        const res = await fetch('http://3.16.148.156:8888/offers-list/get-all-accepted-offers')
    ...
    const startSigningProcess = async (acceptedOffer) => {
        ...
        const res = await fetch('http://3.16.148.156:8888/internship/save-internship',
            {
                method: 'POST',
                headers: {
    ...
    const createContract = async (internship) => {
        ...
        const res = await fetch('http://3.16.148.156:8888/contract/save-contract',
            {
                method: 'POST',
                headers: {
                    'Content-type': 'application/json'
    ...
    const createNotificationStudent = async (internship, notification) => {
        ...
        const result = await fetch(`http://3.16.148.156:8888/notification/save-notification-for-student/${idStudent}`,
            {
                method: 'POST',
                headers: {
                    'Content-type': 'application/json'
    ...
    const confirmStudentOfferInternship = async (acceptedOffer) => {
        ...
        const res = await fetch('http://3.16.148.156:8888/offers-list/save-student-offer',
            {
                method: 'POST',
                headers: {
                    'Content-type': 'application/json'
