        ...
        >
          ...
          <div className="form-group">
            <label htmlFor="jobTitle" className="text-secondary"
              ><i className="fas fa-briefcase"></i> Poste:
            </label>
            <input
              type="text"
              className="form-control text-center"
          ...
          <div className="form-group">
            <label htmlFor="monitorEmail" className="text-secondary"
              ><i className="fas fa-at"></i> Courriel du représentant de
              l'entreprise:
            </label>
            <select
              ...
              required
            >
              <option value="" selected> Veuillez choisir le représentant</option>
              <option
                v-for="monitor in monitors"
                :key="monitor.id"
                :value="monitor.email"
              >
                {{ monitor.email}}</option
              >
            </select>
          </div>
          <div className="form-group">
...
export default {
  name: "AdminInternshipOffer",
  components: {
    AdminNavbar,
  },
  data() {
    return {
      default:"Veuillez choisir le représentant",
      monitors: this.conversion(),
  ...
  methods: {
    conversion() {
      AdminService.getAllMonitors().then((response) => {
